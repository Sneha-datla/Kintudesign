...
export interface ApiApllicationApllication extends Struct.CollectionTypeSchema {
  collectionName: 'apllications';
  info: {
    singularName: 'apllication';
    pluralName: 'apllications';
    displayName: 'Apllication';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::apllication.apllication'
    >;
  };
}

export interface ApiB2BdevB2Bdev extends Struct.CollectionTypeSchema {
  collectionName: 'b2_bdevs';
  info: {
    singularName: 'b2-bdev';
    pluralName: 'b2-bdevs';
    displayName: 'B2Bdev';
  };
  options: {
  ...
  attributes: {
    ...
    JobOffer: Schema.Attribute.Blocks;
    JobResponsibilities: Schema.Attribute.Blocks;
    JobRequirements: Schema.Attribute.Blocks;
...
export interface ApiCheckeditorCheckeditor extends Struct.CollectionTypeSchema {
  collectionName: 'checkeditors';
  info: {
    singularName: 'checkeditor';
    pluralName: 'checkeditors';
    displayName: 'Checkeditor ';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiDevOpDevOp extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::dev-op.dev-op'>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::apllication.apllication': ApiApllicationApllication;
      'api::b2-bdev.b2-bdev': ApiB2BdevB2Bdev;
      'api::blog.blog': ApiBlogBlog;
      'api::carrer.carrer': ApiCarrerCarrer;
      'api::checkeditor.checkeditor': ApiCheckeditorCheckeditor;
